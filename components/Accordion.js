    ...
    return (
        <>
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(1)} className='text-xl text-purple-700 dark:text-purple-500 font-semibold sm:text-base'>
            ...
            <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(2)} className='text-xl text-purple-700 dark:text-purple-500 font-semibold sm:text-base'>
                    Career Development
                </AccordionHeader>
                <AccordionBody className='pt-4 text-md'>
            ...
            <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(3)} className='text-xl text-purple-700 dark:text-purple-500 font-semibold sm:text-base'>
