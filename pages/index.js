          ...
          <Container>
            <Layout>
              <div className='flex flex-col items-end justify-center w-full gap-12'>
                ...
                <AnimatedAccordion />
                <Link href={'/podcast'} className='p-4 bg-light text-dark border-solid border-2 border-dark shadow-[5px_5px_0px_0px_rgba(109,40,217)] dark:text-purple-700 dark:border-light dark:shadow-[5px_5px_0px_0px_rgb(126,34,205)]'>More at Podcasts</Link>
              </div>
            </Layout>
          </Container>
        </main>
